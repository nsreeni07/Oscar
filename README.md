...
| XT90 Female → XT60 Male adapter | 1 | $0 | Battery and power lead interface |
...
| Holybro PM06 V2 power module | 1 | $0 | Power distribution |
| M8N GPS module with compass | 1 | $0 | Position hold, RTL, waypoint navigation — external compass on mast |
| SiK 915MHz telemetry pair | 1 | $0 | Live MAVLink to laptop — mission monitoring over-air |
...
| Item | Qty | Cost | Purpose |
|------|:---:|-----:|---------|
| Raspberry Pi Zero 2W | 1 | $0 | Companion computer — MAVLink listener, distance trigger, camera capture, geotagging |
